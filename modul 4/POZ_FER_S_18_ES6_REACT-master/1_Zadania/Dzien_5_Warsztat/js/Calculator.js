...
class Calculator {
  ...
  */
  add(numberX, numberY) {
    console.error("Powinieneś zaimplementować 'add' w klasie dziedziczącej. ");
  ...
  */
  changeNumber(root) {
    console.error("Powinieneś zaimplementować 'changeNumber' w klasie dziedziczącej. ");
  }

  /* Abstract method changing Result
  */
  updateResult() {
    console.error("Powinieneś zaimplementować 'updateResult' w klasie dziedziczącej. ");
  }
